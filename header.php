...
<?php } ?>
  ...
  <nav class="menu-container">
    <ul class="menu-list ">
      ...
      <li class="menu-item font-text"><a href="https://deceniodeaccion.mx/" target="_blank">Decenio de acción</a></li>
...
<a href="http://www.instagim.com/profile/autotrafficmx/3237038301"  target="_blank">
  ...
  >
    <h1><a href="<?php echo site_url(); ?>">
      <?php $clase = ""; if(!is_page("clientes")) $clase = "logo-vector"?>
