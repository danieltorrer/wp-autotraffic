      ...
      <div class="row">
        ...
        <div class="col-sm-6 no-space wow fadeInRight">
          <div class="solution-item">
            ...
            <div class="solution-description">
              <h4>Estudios históricos <br> <span>de flujo y ocupación vial</span></h4>
              <a href="#"> en tramos determinados</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-4 no-space wow fadeInUp">
          <div class="solution-item small">
            ...
            <div class="solution-description">
              <h4>Estudio <br> <span>de conflictos viales</span></h4>
              <a href="#">en intersecciones</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-4 no-space wow fadeInUp">
          <div class="solution-item small">
            ...
            <div class="solution-description">
              <h4>Promedios <br> <span>de velocidad</span></h4>
              <a href="#">en las vías.</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-4 no-space wow fadeInUp">
          <div class="solution-item small">
            ...
            <div class="solution-description">
              <h4>Identificación <br> <span>de puntos</span></h4>
              <a href="#">con exceso de velocidad</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-4 no-space wow fadeInUp">
          <div class="solution-item small">
            ...
            <div class="solution-description">
              <h4>mantente<br> <span>al pendiente</span></h4>
              <a href="#">Alerta de accidentes</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-4 no-space wow fadeInUp">
          <div class="solution-item small">
            ...
            <div class="solution-description">
              <h4>Detección <br> <span>y alerta</span></h4>
              <a href="#">de congestionamientos viales</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-4 no-space wow fadeInUp">
          <div class="solution-item small">
            ...
            <div class="solution-description">
              <h4>Estudio de <br> <span>resultados comparativos</span></h4>
              <a href="#"> en intervenciones urbanas (antes/después)</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-4 no-space wow fadeInUp">
          <div class="solution-item small">
            ...
            <div class="solution-description">
              <h4>Estudio de <br> <span>resultados comparativos </span></h4>
              <a href="#"> de tramos e intersecciones controladas
(antes/después/ mes vs mes).</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-4 no-space wow fadeInUp">
          <div class="solution-item small">
            ...
            <div class="solution-description">
              <h4>Estudios de <br> <span>tiempos de recorrido </span></h4>
              <a href="#"> y flujo vehicular para planeación urbana</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-4 no-space wow fadeInUp">
          <div class="solution-item small">
            ...
            <div class="solution-description">
              <h4>Muestreo de <br> <span>gases y partículas contaminantes</span></h4>
